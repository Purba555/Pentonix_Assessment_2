...
public class Dept {
    ...
    private static Map<Integer, Emp> employeeDatabase = new HashMap<>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        employeeDatabase.put(1, new Emp(1, "Amal", 10, 30000));
        employeeDatabase.put(2, new Emp(2, "Shyamal", 30, 50000));
        employeeDatabase.put(3, new Emp(3, "Kamal", 40, 10000));
        employeeDatabase.put(4, new Emp(4, "Nirmal", 50, 60000));
        employeeDatabase.put(5, new Emp(5, "Bimal", 20, 40000));
        employeeDatabase.put(6, new Emp(6, "Parimal", 10, 20000));
    ...
    static class DepartmentHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            Emp employee = employeeDatabase.get(eno);
    ...
    public static class Emp 
    {
        ...
        public Emp(int eno, String ename, int dno, int Salary) 
        {
            this.eno = eno;
            this.ename = ename;
            this.dno = dno;
